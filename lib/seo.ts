...
export function buildMetadata(locale: Locale, page: SeoKey): Metadata {
  ...
  return {
    ...
    keywords: [
      ...
      "Night Walk La Fortuna",
      "Night Walk Tour La Fortuna",
      "Night Walk Tour in La Fortuna",
      "Arenal Night Walk Tour",
      "Arenal Volcano Night Walk",
      "Night Walk Costa Rica",
      "La Fortuna Wildlife Night Walk",
      "Costa Rica Night Walk Tour",
